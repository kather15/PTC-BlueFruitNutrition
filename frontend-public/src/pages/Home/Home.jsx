  ...
  return (
    <div className="home">
      ...
      <div className="banner-container">
        <img src="/PantallaPrincipal.png" alt="Banner Blue Fruit" className="banner-image" />
      </div>

      {/* Separador debajo de la imagen */}
      <div className="separador">Nuestros Productos</div>
          ...
          <div className="product" key={index}>
            ...
            >
              ...
              {productoActivo === index && (
                <div className="overlay">Agregar al carrito</div>
              )}
            </div>
            <p>{producto.nombre}</p>
          </div>
      ...
      <div className="boton-ver-todos-container">
        <button className="boton-ver-todos">Ver todos los Productos</button>
      </div>
